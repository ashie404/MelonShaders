...
void main() {
    ...
    albedoOut = albedo;
    lmNormalMatSpecOut = vec4(encodeVec3(vec3(clamp01(lmcoord.xy), clamp01(albedo.a))), encodeNormals(clamp(normalData, -1.0, 1.0)), matMask, encodeVec3(specularData.rgb));
}
